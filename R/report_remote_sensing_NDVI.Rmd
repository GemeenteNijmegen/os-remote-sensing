...
graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_ndvi_distribution_raster_cell_", neighbourhood, ".png"), full.names = TRUE)
...
graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_garden_distribution_ndvi_freq_", neighbourhood, ".png"), 
                         full.names = TRUE)
...
graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_gardens_distribution_ndvi_", neighbourhood, ".png"), 
                         full.names = TRUE)
...
## rs_gardens_distribution_coverage:
```{r pl30, echo=FALSE, fig.cap=" ", out.width = '100%'}
graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_gardens_distribution_vegetation_coverage_", neighbourhood, ".png"), 
                         full.names = TRUE)
...
## water_coverage_garden:
```{r pl310, echo=FALSE, fig.cap=" ", out.width = '100%'}

graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_water_cover_garden", neighbourhood, ".png"), 
                         full.names = TRUE)
...
graph.find <- list.files(path = plots.loc, 
                         pattern = paste0("rs_green_cover_woningen", neighbourhood, ".png"), 
                         full.names = TRUE)
...
## rs_woningen_distribution_coverage:
