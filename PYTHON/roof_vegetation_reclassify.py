...
# Read NDVI tif
chm_filename = files_basename + "_roofs_ndvi.tif"
...
# chm_array[chm_array==int(noDataVal)]= np.nan #Assign CHM No Data Values to NaN ## Controleren of dit nog goed gaat!
...
#Set output filename
classified_roofs = files_basename + "_roofs_ndvi_2_classes.tif"
...
"""
# Read NDVI tif
tif_ndvi = files_basename + "_roofs_ndvi_2_classes.tif"
...
# Write tuinen NDVI
output_roofs_ndvi = files_basename + "_roofs_ndvi_3_classes.tif"
