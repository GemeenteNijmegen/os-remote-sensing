...
# General parameters
directory = workingdirectory + "output/" + buurtcode + "/"
qgis_directory = workingdirectory + "qgis/"
files_basename = directory + buurtcode
gpkg_vector = directory + buurtcode + "_vector.gpkg"
gpkg_raster = directory + buurtcode + "_raster.gpkg"
...
raster_tuinen_classified = QgsRasterLayer(directory + buurtcode + "_tuinen_ndvi_classified.tif", "Tuinen NDVI classified")
...
raster_tuinen_ndvi = QgsRasterLayer(directory + buurtcode + "_tuinen_ndvi.tif", "Tuinen NDVI")
...
raster_daken_classified = QgsRasterLayer(directory + buurtcode + "_daken_ndvi_classified.tif", "Daken NDVI classified")
...
raster_daken_ndvi = QgsRasterLayer(directory + buurtcode + "_daken_ndvi.tif", "Daken NDVI")
...
raster_cir_luchtfoto = QgsRasterLayer(directory + buurtcode + ".tif", "CIR luchtfoto")
raster_ndvi = QgsRasterLayer(directory + buurtcode + "_ndvi.tif", "NDVI")
raster_nir = QgsRasterLayer(directory + buurtcode + "_nir.tif", "NIR")
raster_red = QgsRasterLayer(directory + buurtcode + "_red.tif", "RED")
...
# Zoom to neighboorhood
#layer = QgsProject.instance().mapLayersByName("buurt")[0]
#iface.setActiveLayer(layer)
#zoomlayer = iface.activeLayer()
#zoomlayer.selectAll()
#canvas = iface.mapCanvas()
#canvas.zoomToSelected(zoomlayer)
#zoomlayer.removeSelection()
