...
<qgis minScale="100000000" labelsEnabled="1" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" version="3.16.7-Hannover" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0" readOnly="0" maxScale="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style namedStyle="Standaard" textOrientation="horizontal" fieldName="pGROEN" fontUnderline="0" capitalization="0" fontKerning="1" textColor="0,0,0,255" fontSizeMapUnitScale="3x:0,0,0,0,0,0" isExpression="0" useSubstitutions="0" fontStrikeout="0" fontFamily="MS Shell Dlg 2" allowHtml="0" fontWeight="50" textOpacity="1" blendMode="0" fontLetterSpacing="0" multilineHeight="1" fontSize="10" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontItalic="0" fontSizeUnit="Point">
        <text-buffer bufferOpacity="1" bufferNoFill="1" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferSizeUnits="MM" bufferColor="255,255,255,255" bufferJoinStyle="128" bufferBlendMode="0" bufferDraw="1" bufferSize="1"/>
        <text-mask maskSize="1.5" maskedSymbolLayers="" maskEnabled="0" maskType="0" maskJoinStyle="128" maskOpacity="1" maskSizeUnits="MM" maskSizeMapUnitScale="3x:0,0,0,0,0,0"/>
        <background shapeDraw="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="MM" shapeOpacity="1" shapeBorderColor="128,128,128,255" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidth="0" shapeRadiiUnit="MM" shapeFillColor="255,255,255,255" shapeSizeX="0" shapeOffsetY="0" shapeSizeType="0" shapeSVGFile="" shapeJoinStyle="64" shapeRadiiY="0" shapeSizeUnit="MM" shapeRotationType="0" shapeRotation="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeBlendMode="0" shapeType="0" shapeSizeY="0" shapeOffsetX="0" shapeOffsetUnit="MM" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0">
        ...
        <shadow shadowUnder="0" shadowRadius="1.5" shadowOffsetDist="1" shadowColor="0,0,0,255" shadowOffsetUnit="MM" shadowDraw="0" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.7" shadowScale="100" shadowBlendMode="6" shadowRadiusAlphaOnly="0" shadowOffsetAngle="135" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1"/>
        <dd_properties>
          <Option type="Map">
            <Option type="QString" name="name" value=""/>
            <Option name="properties"/>
      ...
      <text-format multilineAlign="3" placeDirectionSymbol="0" autoWrapLength="0" decimals="3" wrapChar="" addDirectionSymbol="0" formatNumbers="0" reverseDirectionSymbol="0" leftDirectionSymbol="&lt;" rightDirectionSymbol=">" plussign="0" useMaxLineLengthForAutoWrap="1"/>
      <placement dist="0" placement="0" placementFlags="10" repeatDistanceUnits="MM" geometryGeneratorType="PointGeometry" lineAnchorType="0" distUnits="MM" centroidInside="0" maxCurvedCharAngleIn="25" overrunDistanceUnit="MM" geometryGeneratorEnabled="0" offsetUnits="MM" yOffset="0" layerType="PolygonGeometry" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistance="0" overrunDistance="0" geometryGenerator="" fitInPolygonOnly="0" rotationAngle="0" offsetType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" polygonPlacementFlags="2" lineAnchorPercent="0.5" quadOffset="4" priority="5" centroidWhole="0" xOffset="0" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0"/>
      <rendering obstacleType="1" zIndex="0" obstacle="1" limitNumLabels="0" scaleMax="0" labelPerPart="0" upsidedownLabels="0" fontLimitPixelSize="0" minFeatureSize="0" mergeLines="0" displayAll="0" fontMinPixelSize="3" fontMaxPixelSize="10000" scaleMin="0" drawLabels="1" scaleVisibility="0" obstacleFactor="1" maxNumLabels="2000"/>
      <dd_properties>
        <Option type="Map">
          <Option type="QString" name="name" value=""/>
          <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="None" name="pGROEN">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias field="pGROEN" name="" index="15"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" field="pGROEN" expression=""/>
  </defaults>
  <constraints>
    ...
    <constraint exp_strength="0" unique_strength="0" field="pGROEN" notnull_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    ...
    <constraint exp="" desc="" field="pGROEN"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" name="pGROEN" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    ...
    <field name="pGROEN" labelOnTop="0"/>
