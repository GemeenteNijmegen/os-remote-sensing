...
<qgis minScale="1e+08" version="3.16.7-Hannover" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  ...
  <pipe>
    ...
    <rasterrenderer type="paletted" band="1" nodataColor="" opacity="1" alphaBand="-1">
      ...
      <colorPalette>
        <paletteEntry alpha="255" value="10" label="Tuin - water" color="#415dff"/>
        <paletteEntry alpha="255" value="20" label="Tuin - vergroenings/verblauwingspotentieel" color="#ffab3d"/>
        <paletteEntry alpha="255" value="30" label="Tuin - groen" color="#00b043"/>
      </colorPalette>
