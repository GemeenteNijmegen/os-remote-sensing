...
png(paste0(plots.dir,"rs_rgb_vegi_substantial_",neighbourhood,".png"), bg="white", width=png_height*aspect_ratio, height=png_height)
...
png(paste0(plots.dir,"rs_rgb_vegi_classes_unsupervised_",neighbourhood,".png"), bg="white", width=png_height*aspect_ratio, height=png_height)
par(col.axis = "white", col.lab = "white", tck = 0)
...
png(paste0(plots.dir,"rs_rgb_vegi_classes_fixed_",neighbourhood,".png"), bg="white", width=png_height*aspect_ratio, height=png_height)
par(col.axis = "white", col.lab = "white", tck = 0)
...
#plot RVI
png(paste0(plots.dir,"rs_rvi1_",neighbourhood,".png"), bg="white", width=png_height*aspect_ratio, height=png_height)
par(col.axis = "white", col.lab = "white", tck = 0)
