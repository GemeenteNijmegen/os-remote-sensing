...
par(col.axis = "white", col.lab = "white", tck = 0)
raster::plotRGB(ai_tuinen, r=1, g=2, b=3, axes=TRUE, stretch="lin",colNA='transparent',main=paste0("(non)vegetation classification ", neighbourhood))
...
par(col.axis = "white", col.lab = "white", tck = 0)
raster::plotRGB(ai_tuinen, r=1, g=2, b=3, axes=TRUE, stretch="lin",colNA='transparent',main=paste0("composite image stack RGB and classes (unsupervised) ", neighbourhood))
